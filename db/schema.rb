...
ActiveRecord::Schema.define(version: 20140920213821) do
  ...
  create_table "profiles", force: true do |t|
    ...
    t.integer  "user_id"
    t.boolean  "daily_email_reminder"
  ...
  create_table "responses", force: true do |t|
    t.string   "writer"
    t.text     "response"
    t.integer  "writing_challenge_id"
    t.integer  "user_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.date     "time"
  ...
  create_table "writing_challenges", force: true do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "exercise"
    t.integer  "user_id"
